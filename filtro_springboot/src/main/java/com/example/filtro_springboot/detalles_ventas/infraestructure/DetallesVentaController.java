...
@RestController
@RequestMapping(path = "api/v1/detalles-venta")
public class DetallesVentaController {
    ...
    public Optional<DetallesVenta> getById(@PathVariable("detallesVentaId") Long objectId) {
        return detallesVentaService.getDetallesVenta(objectId);
    }
}